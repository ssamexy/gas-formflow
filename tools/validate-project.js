...
if (distHtml.includes('confirm(')) fail('Browser confirm dialogs must be replaced with the accessible in-app dialog');
if (!distHtml.includes('confirmCancelBtn.focus()')) fail('In-app confirmation dialogs must default focus to the safe cancel action');
